...
class TestMagazine:
    ...
    def test_article_titles(self):
        ...
        assert magazine_3.article_titles() is None  # Ensure magazine with no articles returns None
    ...
    def test_contributing_authors(self):
        ...
        assert magazine_2.contributing_authors() is None  # Ensure magazine with no authors with more than 2 articles returns None
